...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_h',       type=int,   default=384,        help='输入图像高度')
    parser.add_argument('--img_w',       type=int,   default=288,        help='输入图像宽度')
    parser.add_argument('--hm_h',        type=int,   default=96,         help='输出热图高度')
    parser.add_argument('--hm_w',        type=int,   default=72,         help='输出热图宽度')
